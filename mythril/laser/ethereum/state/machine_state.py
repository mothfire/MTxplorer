...
class MachineState:
    ...
    def __init__(
        ...
        self.stack2 = MachineStack(stack)
        ...
        self.jumpdest_list = []
        self.jumpi = False
        self.jumpi_flag = False
        self.end_opcode = None
        self.storage_change = False
    ...
    def __deepcopy__(self, memodict=None):
        ...
        new_machine_state.stack2 = copy(self.stack2)
        new_machine_state.sload = self.sload
        new_machine_state.slot = self.slot
        new_machine_state.offset = self.offset
        new_machine_state.size = self.size
        new_machine_state.sha3_dist = copy(self.sha3_dist)
        new_machine_state.sha3_map = copy(self.sha3_map)
        new_machine_state.jumpdest_list = copy(self.jumpdest_list)
        new_machine_state.jumpi = self.jumpi
        new_machine_state.jumpi_flag = self.jumpi_flag
        new_machine_state.storage_change = self.storage_change
